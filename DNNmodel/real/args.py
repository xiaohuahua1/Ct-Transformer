...
def CtTransformer_pretrain_args_parser():
    ...
    parser.add_argument('--Linear_lr', type=float, default=0.0005, help='learning rate')
    parser.add_argument('--Linear_weight_decay', type=float, default=0.001, help='weight decay')
    parser.add_argument('--Linear_step_size', type=int, default=4, help='step size')
